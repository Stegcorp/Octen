...
//           let divSims = document.createElement('div')
//             divSims.classList.add('member')
//             divSims.innerText = `${simp.name} ${simp.surname} ${simp.age}`
//             document.body.appendChild(divSims)
//     }
...
//     divImg.src = simp.photo
//     divSims.appendChild(divName)
//     divSims.appendChild(divSurName)
//     divSims.appendChild(divAge)
//     divSims.appendChild(divInfo)
//     divSims.appendChild(divImg)
// }
//
...
for (const coursesElement of coursesArray) {
    ...
    for (const module of coursesElement.modules) {
        let le = document.createElement('li')
        le.innerText = module
        modules.appendChild(le)
    }
    title.innerText = coursesElement.title
    monthDuration.innerText = 'monthDuration'+' '+coursesElement.monthDuration
    ...
    let style = document.getElementsByTagName('div')
